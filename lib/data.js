  ...
  const events = await fetch('https://api2.hackclub.com/v0/Sessions/Events')
    ...
    .then((events) =>
      events.map(({ id, fields }) => ({
        ...
        avatar: fields['Avatar'][0] ? fields['Avatar'][0].thumbnails.small.url : 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/320/apple/81/shrug_1f937.png'
      }))
    )
